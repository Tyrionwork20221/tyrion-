        ...
        <div>
          <div>
            ...
            <h4 className="text-lg mb-16">
              Forgot password?{" "}
              <span className="text-[#fbc108]">Reset password</span>
            </h4>

            <button className="w-558 h-16 bg-[#FBC108] text-white mb-5 rounded-lg font-medium text-lg mb-4 ">
              Sign in
            </button>

            <h4 className="text-lg font-medium">
              Don't have an account?{" "}
              <span className="text-[#fbc108]">Create an account</span>
            </h4>
          </div>
        </div>
