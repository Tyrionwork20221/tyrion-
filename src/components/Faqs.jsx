...
function Faqs() {
  return (
    <div className="font-DMSans h-full pt-12">
      ...
      {/* title */}
      <h1 className="md:mt-44 md:text-6xl font-bold text-center md:mb-36">
        Frequently asked <span className="text-[#FBC108]">questions</span>
      </h1>

      {/* content */}

      <div className="md:ml-36 md:mt-16 mt-9 ml-10">
        <div>
          <div className="flex items-center gap-12">
            <img src={radio} alt="" className="self-start w-5 md:w-11" />
            <div>
              <h1 className="font-lg font-bold md:text-2xl text-base ">
                What does <span className="text-[#FBC108]">tyrion</span> offer?
              </h1>
              <p className="md:mt-8 mt-5 text-base text-[#00000063] mr-12 md:mr-700">
        ...
        <div className="flex md:gap-12 gap-6 md:mb-40 mb-20">
          <button className="md:w-280 w-52  rounded-lg md:h-14 h-8 bg-[#FBC108] text-white font-medium md:text-xl hover:bg-[#FFCC00] active:bg-blue-200 ">
            Create an account
          </button>
          <button className="border border-yellow-500 border-2px md:w-52 w-24 h-8 md:h-14 rounded-lg md:text-xl font-medium  hover:bg-[#fbc108] hover:text-white hover:border-none active:bg-blue-200">
            Sign in
          </button>
        </div>
      </div>
